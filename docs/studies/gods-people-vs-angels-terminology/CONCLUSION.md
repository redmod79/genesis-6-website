...
Greek has TWO distinct words:
- **υἱός (huios)** - "son" - emphasizes status, legal standing, rights
- **τέκνον (teknon)** - "child" - emphasizes origin, birth, nature
...
The LXX translators rendered the **same Hebrew phrase** (בְּנֵי הָאֱלֹהִים) two different ways:
- **Genesis 6** → υἱοὶ τοῦ θεοῦ ("sons of God")
- **Job 1-2, 38** → ἄγγελοι τοῦ θεοῦ ("angels of God")
...
1. **The Hebrew phrase בְּנֵי הָאֱלֹהִים is identical** in Gen 6:2,4 and Job 1:6; 2:1
   - Same construction: construct plural of בֵּן + definite article + אֱלֹהִים

2. **The LXX translators distinguished them**
   - Gen 6 → υἱοὶ τοῦ θεοῦ (sons of God)
   - Job → ἄγγελοι τοῦ θεοῦ (angels of God)

3. **Phrases used for Israel are different**
...
4. **NT reserves "sons/children of God" exclusively for humans**
...
**Key Finding:** The combined OT+NT semantic range shows:
- "Sons of God" phrases CAN refer to humans (Deut 14:1; Hos 1:10; all NT)
- "Sons of God" phrases CAN refer to heavenly beings (Job; Psalms)
- The phrase בְּנֵי הָאֱלֹהִים specifically appears only in contexts referring to heavenly beings (Job) OR the disputed Genesis 6
...
1. **The exact phrase בְּנֵי הָאֱלֹהִים** appears only in:
   - Job (undisputed heavenly beings)
   - Genesis 6 (disputed)

2. **When OT refers to humans as God's children**, it uses DIFFERENT constructions:
   - בָּנִים לַיהוָה (Deut 14:1) - different preposition
   - בְּנֵי אֵל־חָי (Hos 1:10) - different divine name

3. **The NT semantic range** confirms "sons of God" CAN refer to humans, but NT authors never encountered the need to apply it to angels (since they used ἄγγελοι for that).

4. **The LXX translators** (who knew both semantic ranges) chose NOT to translate Genesis 6 as "angels" - unlike their handling of Job.
...
*Method: Linguistic comparison only*
