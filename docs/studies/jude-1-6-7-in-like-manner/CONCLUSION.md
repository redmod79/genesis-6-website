# Conclusion: What Does "In Like Manner" Refer to in Jude 1:7?
...
1. **Constructio ad sensum:** NT authors use masculine pronouns/participles for feminine cities when referring to **inhabitants**:
   - **Acts 8:5:** τὴν πόλιν τῆς Σαμαρίας (fem) + αὐτοῖς (masc dative pl) = preached to inhabitants
   - **Acts 8:14:** ἡ Σαμάρια (fem) + αὐτοὺς (masc acc pl) = sent to inhabitants
   - Luke 10:13: Tyre/Sidon (fem) + καθήμενοι (masc) = inhabitants sitting
   - Matt 23:37: Jerusalem (fem) + ἠθελήσατε (2pl) = people not willing
   - Gal 3:16: σπέρματι (neut) + ὅς (masc) = referring to Christ
   - Rev 4:8: ζῷα (neut) + λέγοντες (masc) = creatures as persons

2. **The Acts 8:5 parallel is particularly strong:** It uses αὐτοῖς (dative plural masculine) for a feminine city - the exact same case as τούτοις in Jude 1:7.

3. **The pattern is well-documented:** Greek allows gender to follow sense rather than strict agreement, with multiple clear NT examples.
...
Jude gives three examples of divine judgment:
1. Unbelieving Israel (v5)
2. Angels who sinned (v6)
3. Sodom and surrounding cities (v7)
...
This suggests:
- If the connection is significant, it is **unique to Jude's emphasis**
- If the connection is merely structural, the parallel to 2 Peter supports Reading B
...
The Hebrew OT typically uses:
- Explicit phrases like "men of Sodom" (Gen 13:13; 19:4)
- Strict grammatical agreement (Ezek 16:50 uses 3rd fem plural verb for Sodom)
...
1. **What makes better sense of Jude's argument?**
   - Is Jude connecting the sins of angels and Sodom theologically?
   - Or is he clarifying that all the cities (not just Sodom) sinned?

2. **What does "strange flesh" mean?**
   - If angelic flesh: Reading A is strengthened
   - If homosexual relations: Reading B is more natural

3. **What is the relationship to Genesis 6?**
   - If Jude assumes Gen 6:1-4 describes angel-human unions: Reading A fits
   - If Jude is not making this connection: Reading B is simpler

4. **How much weight to give 2 Peter?**
   - If Peter and Jude share a tradition: Peter's silence on the parallel is notable
   - If Jude is independent: his "in like manner" phrase may be significant
...
Interpreters should:
- Acknowledge the grammatical ambiguity
- Evaluate the contextual and theological arguments for each reading
- Avoid claiming grammatical certainty for either position
