# Historical Context: Second Temple Literature, Pagan Mythology, and Pentateuch Legislative Silence
...
*See: [second-temple-literature-genesis-6 study](../studies/second-temple-literature-genesis-6/CONCLUSION.md)*
...
| "Giants" ([nephilim](https://www.blueletterbible.org/lexicon/h5303/kjv/wlc/0-1/)) | Elaborate giant mythology (3,000 ells tall, cannibalism) |
...
| **Standard LXX** (Rahlfs-Hanhart) | ~3rd cent. BC | "sons of God" ([huioi](https://www.blueletterbible.org/lexicon/g5207/kjv/tr/0-1/) tou theou) | NOT "angels of God" |

The Septuagint evidence is particularly noteworthy. The same LXX translators who rendered the Hebrew "bene elohim" as "angels of God" ([angeloi](https://www.blueletterbible.org/lexicon/g32/kjv/tr/0-1/) tou theou) in Job 1:6 deliberately chose "sons of God" (huioi tou theou) for Genesis 6:2. They saw a contextual difference and translated accordingly.
...
Paul quotes Epimenides of Crete, calling him "a prophet" using the same Greek word family (prophetes, [G4396](https://www.blueletterbible.org/lexicon/g4396/kjv/tr/0-1/)) that Jude uses (epropheteusen, [G4395](https://www.blueletterbible.org/lexicon/g4395/kjv/tr/0-1/)) -- yet no one argues Paul thereby endorses Epimenides' Cretan religion.
...
- Genesis 4: Cain's ungodly line -- murder, arrogance, polygamy, violence
...
God addresses them as "man" ([adam](https://www.blueletterbible.org/lexicon/h120/kjv/wlc/0-1/)). He calls them "flesh" ([basar](https://www.blueletterbible.org/lexicon/h1320/kjv/wlc/0-1/)) -- a term never used for angels anywhere in Scripture. He limits their lifespan to 120 years -- applicable only to human beings. If angels were the problem, God's response is inexplicably focused on human judgment.

**C. Standard marriage vocabulary:**
Genesis 6:2 uses "took them wives" (wayyiqhu lahem [nashim](https://www.blueletterbible.org/lexicon/h802/kjv/wlc/0-1/)) -- the standard Hebrew idiom for human marriage, identical to the vocabulary used in Deuteronomy 7:3 for intermarriage with pagan nations.
...
**The silence is significant because:**
- Moses is the author of both texts (Genesis 6 and the sexual legislation)
- Moses legislated against every category of sexual sin
- Moses prohibited cross-species sexual contact (bestiality) using the Hebrew word *tebel* ([H8397](https://www.blueletterbible.org/lexicon/h8397/kjv/wlc/0-1/), "confusion/mixture") -- demonstrating he had the vocabulary for cross-category violations
- The legislation is explicitly intended to be exhaustive (Lev 18:24-30)
- If angel-human unions were a known danger, why no warning?
- The angel view requires believing the worst sexual sin imaginable received no prohibition
...
The same marriage vocabulary connects the two passages. Genesis 6:2 uses "took them wives" (wayyiqhu lahem nashim); Deuteronomy 7:3 uses the same verb *laqach* ([H3947](https://www.blueletterbible.org/lexicon/h3947/kjv/wlc/0-1/)) in the same marital context. Under the Sethite view, Deuteronomy 7:3-4 IS the legislative response to the Genesis 6 pattern, making the Pentateuch internally coherent.

*See: [pentateuch-sexual-legislation-angel-unions study](../studies/pentateuch-sexual-legislation-angel-unions/CONCLUSION.md)*
...
*Next: [07-verdict.md](07-verdict.md) -- Final Verdict and Synthesis*

---

*Source studies: [second-temple-literature-genesis-6](../studies/second-temple-literature-genesis-6/CONCLUSION.md), [pentateuch-sexual-legislation-angel-unions](../studies/pentateuch-sexual-legislation-angel-unions/CONCLUSION.md)*
