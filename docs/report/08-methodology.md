...
- **Step 8:** "Strange flesh" ([sarkos](https://www.blueletterbible.org/lexicon/g4561/kjv/tr/0-1/) [heteras](https://www.blueletterbible.org/lexicon/g2087/kjv/tr/0-1/)) more naturally refers to homosexuality. The men of Sodom did not know the visitors were angels (Genesis 19:5 calls them "men") and refused female substitutes (Genesis 19:8), indicating same-sex desire.
...
> **Genesis 4:19; 11:29; 24:67** And Lamech **took** unto him **two wives**... And Abram and Nahor **took them wives**... And Isaac brought her into his mother Sarah's tent, and **took** Rebekah, and she became his **wife**. [Same marriage vocabulary as Genesis 6:2: "took them wives" = [laqach](https://www.blueletterbible.org/lexicon/h3947/kjv/wlc/0-1/) [nashim](https://www.blueletterbible.org/lexicon/h802/kjv/wlc/0-1/)]
...
> **Romans 8:14** For as many as are led by the Spirit of God, they are the **sons of God** (*[huioi](https://www.blueletterbible.org/lexicon/g5207/kjv/tr/0-1/) theou*).

> **Galatians 3:26** For ye are all the **children of God** (*huioi theou*) by faith in Christ Jesus.

> **John 1:12** But as many as received him, to them gave he power to become the **sons of God** (*[tekna](https://www.blueletterbible.org/lexicon/g5043/kjv/tr/0-1/) theou*), even to them that believe on his name.
...
When the broader analysis includes all supporting arguments (see [CONCLUSION.md](../studies/genesis-6-explicit-vs-implied-evidence/CONCLUSION.md) for the full 20-argument inventory), the human view totals 19 explicit and 1 implied (ratio 19:1), while the angel view totals 2 explicit and 11 implied (ratio 2:11). The 10-step chains above present the core arguments; the full study extends each view with additional lines of evidence.
...
The broader study (see [03-analysis.md](../studies/genesis-6-explicit-vs-implied-evidence/03-analysis.md)) extends these counts: angel view 2:11 explicit-to-implied; human view 19:1 explicit-to-implied.
...
1. "Bene elohim" in Job = heavenly beings (Job 1:6; 2:1; 38:7)
...
1. Genesis 4 establishes two contrasting lines (Cain vs. Seth)
2. Seth's line called upon the name of the LORD (Genesis 4:26)
3. Enoch walked with God (Genesis 5:22, 24)
4. God calls the subjects "man" and "flesh" (Genesis 6:3)
5. "Took them wives" = standard marriage vocabulary
6. Jesus says angels do not marry (Matthew 22:30; Mark 12:25; Luke 20:35-36)
7. "Sons of God" can refer to humans (Romans 8:14; Galatians 3:26; John 1:12; etc.)
8. All stated flood reasons are moral (Genesis 6:5-7, 11-13)
...
This is what the text **says**. God's own response to the sons-of-God situation identifies the subjects as "man" ([adam](https://www.blueletterbible.org/lexicon/h120/kjv/wlc/0-1/)) and "flesh" ([basar](https://www.blueletterbible.org/lexicon/h1320/kjv/wlc/0-1/)). The term "flesh" is never applied to angels anywhere in Scripture. The lifespan limit ("his days shall be an hundred and twenty years") is irrelevant to angelic beings. The angel view must explain why God would identify angels as "man" and "flesh."
...
This is what Jesus **says**. He uses angelic nature as the standard for the non-marrying state. Luke's "equal unto the angels" ([isangeloi](https://www.blueletterbible.org/lexicon/g2465/kjv/tr/0-1/)) contains no "in heaven" qualifier, making it a categorical statement about what angels are. The angel view must explain how angels could marry if Jesus says they do not.
...
This is what the text **says**. Wickedness. Evil thoughts. Violence. Moral corruption. Not one word about genetic contamination, hybrid offspring, or angelic interference. The phrase "corrupted his way" ([shachath](https://www.blueletterbible.org/lexicon/h7843/kjv/wlc/0-1/) + [derek](https://www.blueletterbible.org/lexicon/h1870/kjv/wlc/0-1/)) is moral in every biblical parallel (Deuteronomy 9:12; 31:29; Judges 2:19). The angel view must explain why genetic corruption is never mentioned if it was the reason for the flood.
...
*Cross-references: See [00-overview.md](00-overview.md) for the full study framework. See [01-positive-case.md](01-positive-case.md) for the Genesis 4-5 context. See [02-jesus-teaching.md](02-jesus-teaching.md) for detailed analysis of Matthew 22:30 and Luke 20:35-36. See [07-verdict.md](07-verdict.md) for the full scorecard and claims assessment. Full argument inventories with all 13 angel-view and 20 human-view arguments are documented in [03-analysis.md](../studies/genesis-6-explicit-vs-implied-evidence/03-analysis.md) and [CONCLUSION.md](../studies/genesis-6-explicit-vs-implied-evidence/CONCLUSION.md).*

---

*Next: [09-study-references.md](09-study-references.md) -- Study References*
