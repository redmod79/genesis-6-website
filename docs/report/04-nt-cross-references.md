# NT Cross-References: 2 Peter 2:4, Jude 6-7, and 1 Peter 3:19-20
...
**Translation note:** "Cast them down to hell" translates the single Greek verb [*tartaroo*](https://www.blueletterbible.org/lexicon/g5020/kjv/tr/0-1/) (G5020) -- "cast to Tartarus." This is not the usual New Testament words for hell: not [*gehenna*](https://www.blueletterbible.org/lexicon/g1067/kjv/tr/0-1/) (the final place of punishment) and not [*hades*](https://www.blueletterbible.org/lexicon/g86/kjv/tr/0-1/) (the grave/realm of the dead). *Tartaroo* appears only here in the entire Bible. The KJV translates it as "hell," but the Greek word is specifically Tartarus -- a term Peter's audience would have associated with the imprisonment of the Titans after their **rebellion** against the divine order (see below).
...
Peter uses the verb *tartaroo* ([G5020](https://www.blueletterbible.org/lexicon/g5020/kjv/tr/0-1/)) -- "cast down to Tartarus" -- a term used only here in the entire New Testament. In Greek cultural background, Tartarus was where the Titans were imprisoned after *rebelling* against Zeus. The Titans did not marry humans; they waged war against the divine order. Peter's Greek audience would have understood *tartaroo* as punishment for rebellion against divine authority, reinforcing the reading of angelic rebellion rather than sexual transgression.

### "Chains of Darkness" Is Figurative for Condemnation

The angel view often reads "chains of darkness" as a literal prison, then constructs a "two-class angel theory" -- one class imprisoned, another class (Satan and active demons) free. But the same Greek word [*zophos*](https://www.blueletterbible.org/lexicon/g2217/kjv/tr/0-1/) ("darkness") applies to beings who are clearly not imprisoned:
...
*For the full analysis, see the detailed study at [2-peter-2-4-angels-that-sinned](../studies/2-peter-2-4-angels-that-sinned/CONCLUSION.md).*
...
**Arche ([G746](https://www.blueletterbible.org/lexicon/g746/kjv/tr/0-1/)) -- "First Estate"**
...
**Apoleipo ([G620](https://www.blueletterbible.org/lexicon/g620/kjv/tr/0-1/)) -- "Left"**
...
**Oiketerion ([G3613](https://www.blueletterbible.org/lexicon/g3613/kjv/tr/0-1/)) -- "Habitation"**
...
*For the full analysis, see the detailed study at [jude-6-7-angels-sin](../studies/jude-6-7-angels-sin/CONCLUSION.md).*
...
### "Strange Flesh" -- Heteros ([G2087](https://www.blueletterbible.org/lexicon/g2087/kjv/tr/0-1/))

The Greek phrase is *heteras [sarkos](https://www.blueletterbible.org/lexicon/g4561/kjv/tr/0-1/)* -- "different flesh." The word [*heteros*](https://www.blueletterbible.org/lexicon/g2087/kjv/tr/0-1/) means "another of a different kind" (distinguished from [*allos*](https://www.blueletterbible.org/lexicon/g243/kjv/tr/0-1/), another of the same kind). The question is: different from *what*?
...
- **Genesis 19:4-5:** The men of Sodom demanded "the men" (*[ha-anashim](https://www.blueletterbible.org/lexicon/h376/kjv/wlc/0-1/)*). They perceived ordinary men, not angels.
...
- **Romans 1:26-27:** Paul describes homosexuality as "against nature" (*[para](https://www.blueletterbible.org/lexicon/g3844/kjv/tr/0-1/) [physin](https://www.blueletterbible.org/lexicon/g5449/kjv/tr/0-1/)*) -- exchanging the natural use for that which is against nature.
- **Genesis 19:4-9:** The narrative confirms homosexual desire: the men wanted males, refused females.
- **Ezekiel 16:50:** Sodom committed "abomination" ([*toebah*](https://www.blueletterbible.org/lexicon/h8441/kjv/wlc/0-1/)) -- the same term used in Leviticus 18:22 for homosexuality.
...
2. **Grammatical proximity.** The demonstrative *[toutois](https://www.blueletterbible.org/lexicon/g5125/kjv/tr/0-1/)* ("to these") more naturally refers to the nearest antecedent. Option A requires skipping over "the cities about them" to connect back to verse 6.
...
The phrase "by which" (*en ho*) in verse 19 connects back to "the Spirit" (*[pneumati](https://www.blueletterbible.org/lexicon/g4151/kjv/tr/0-1/)*) at the end of verse 18. The Spirit by whom Christ was made alive is the same Spirit by whom He "went and preached." This grammatical connection is foundational to the interpretation.
...
> **2 Peter 2:5** -- "And spared not the old world, but saved Noah the eighth person, a **preacher** ([*kerux*](https://www.blueletterbible.org/lexicon/g2783/kjv/tr/0-1/)) **of righteousness**, bringing in the flood upon the world of the ungodly."

The noun *kerux* ("preacher/herald") is the agent noun corresponding to the verb [*kerusso*](https://www.blueletterbible.org/lexicon/g2784/kjv/tr/0-1/) ("preached") in 1 Peter 3:19. The same author, in a parallel passage, identifies Noah as one who proclaimed righteousness to his generation. The pieces fit: Christ, by His Spirit, preached through Noah the preacher.
...
The objection is sometimes raised: why would Peter call them "spirits" if he meant living humans? But Scripture uses [*pneumata*](https://www.blueletterbible.org/lexicon/g4151/kjv/tr/0-1/) ("spirits") for humans:
...
*For the full analysis, see the detailed study at [1-peter-3-spirits-in-prison](../studies/1-peter-3-spirits-in-prison/CONCLUSION.md).*
...
**Note on Sodom/Gomorrah gender classification:** The Nestle 1904 Text-Fabric database parses Σόδομα and Γόμορρα as feminine. However, Strong's and other lexicons classify Σόδομα as neuter ([G4670](https://www.blueletterbible.org/lexicon/g4670/kjv/tr/0-1/)) and Γόμορρα as neuter or feminine ([G1116](https://www.blueletterbible.org/lexicon/g1116/kjv/tr/0-1/)). Hebrew place names transliterated into Greek frequently exhibit variable gender classification. This discrepancy does not affect the core argument: whether feminine or neuter, these nouns are not masculine, so the grammatical tension with τούτοις (masculine) remains in full force.
...
*Next: [05-nephilim-and-flood.md](05-nephilim-and-flood.md) -- The Nephilim, the Flood, and the Question of "Genetic Corruption"*

---

*Report compiled: 2026-02-10*
*Source studies: [2-peter-2-4-angels-that-sinned](../studies/2-peter-2-4-angels-that-sinned/CONCLUSION.md), [jude-6-7-angels-sin](../studies/jude-6-7-angels-sin/CONCLUSION.md), [jude-1-6-7-in-like-manner](../studies/jude-1-6-7-in-like-manner/CONCLUSION.md), [strange-flesh-jude-1-7](../studies/strange-flesh-jude-1-7/CONCLUSION.md), [1-peter-3-spirits-in-prison](../studies/1-peter-3-spirits-in-prison/CONCLUSION.md)*
